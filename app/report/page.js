...
export default async function Report() {
  ...
  const upiTotal = allSales
    .filter((b) => b.paymentType === "upi")
    .reduce((s, b) => s + b.netAmount, 0);
  const CreditTotal = allSales
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              sub: `${allSales.length} bills`,
              border: "border-violet-500",
              text: "text-violet-700",
            },
            {
              label: "Cash Sales",
              value: `₹${cashTotal.toFixed(0)}`,
              sub: "Cash payments",
