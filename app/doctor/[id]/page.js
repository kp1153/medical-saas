...
const TEST_CATEGORIES = {
  "🩸 Blood Tests": [
    "CBC", "Blood Sugar Fasting", "Blood Sugar PP", "HbA1c",
    "Lipid Profile", "LFT", "KFT", "Thyroid TSH", "Thyroid T3/T4",
    "Uric Acid", "ESR", "CRP", "Serum Calcium", "Vitamin D", "Vitamin B12",
    "Iron Studies", "PT/INR", "Dengue NS1", "Malaria", "Typhoid Widal",
  ],
  "🧪 Urine / Stool": [
    "Urine R/M", "Urine Culture", "24hr Urine Protein",
    "Stool R/M", "Stool Culture",
  ],
  "📷 X-Ray": [
    "X-Ray Chest PA", "X-Ray KUB", "X-Ray Spine LS",
    "X-Ray Spine CS", "X-Ray Hand", "X-Ray Knee", "X-Ray Pelvis",
    "X-Ray Shoulder", "X-Ray Ankle", "X-Ray PNS",
  ],
  "🔊 Ultrasound": [
    "USG Abdomen", "USG Pelvis", "USG Abdomen + Pelvis",
    "USG Thyroid", "USG Obstetric", "USG KUB",
    "USG Breast", "USG Scrotum",
  ],
  "🧲 MRI": [
    "MRI Brain", "MRI Spine LS", "MRI Spine CS",
    "MRI Knee", "MRI Shoulder", "MRI Abdomen",
    "MRI Pelvis", "MRI Wrist",
  ],
  "🔬 CT Scan": [
    "CT Brain", "CT Chest", "CT Abdomen",
    "CT KUB", "CT Spine LS", "CT PNS",
    "CT Angiography", "CT Pelvis",
  ],
  "❤️ Cardiac": [
    "ECG", "Echo 2D", "TMT", "Holter 24hr",
  ],
  "👁️ Other": [
    "Biopsy", "Endoscopy", "Colonoscopy",
    "PFT", "EEG", "EMG/NCV", "Bone Density (DEXA)",
  ],
};
